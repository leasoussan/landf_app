...
export const add_suggestion = (req, res) => {

    console.log("SUGGESTION SAVE START  ", req.body);
    const { type,suggestionItem_id, item_id, conversation } = req.body;

    db('suggestion')
        .insert(req.body)
        .returning('*')
        .then(rows => {
            console.log('-----------save---suggestion',rows);
            res.json(rows)
        })
        .catch(e => {
            console.log(e);
...
export const suggestion_detail = async (req, res) => {
    console.log("what are ou suggestion_detail?? ", req.body);
    const { id } = req.params;
    console.log("sugestion id - readt suggestion detail", id);
    try {
...
// // CREATE ONE SUGGESTION
// export const add_conversation = (req, res) => {

//     console.log("conversation SAVE START  ", req.body);
//     const { date_started, user_id, conversation } = req.body;
