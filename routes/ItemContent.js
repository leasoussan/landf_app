...
item_content.post('/item_content',add_item_content );
item_content.get('/item_content_detail/:id',item_content_detail );
item_content.put('/edit_item_content/:id',edit_item_content )
item_content.delete('/delet_item_content/:id',delet_item_content );
